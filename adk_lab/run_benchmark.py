"""Run the shared benchmark question set against the ADK-style agent."""
...
from adk_lab.agent import run_adk_workflow
...
def main() -> int:
    ...
    for question in BENCHMARK_QUESTIONS:
        report, trace = run_adk_workflow(question)
        reports.append(report.model_dump(mode="json"))
        traces.append(trace.model_dump(mode="json"))

    report_path = Path("results/reports/adk_report.json")
    trace_path = Path("results/traces/adk_trace.json")
